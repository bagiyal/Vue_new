                ...
                <div class="row h-100">
                    ...
                    @if (count($errors) > 0)
                                <div  class="alert alert-danger alert-dismissible  show" role="alert" style="padding: 2rem 0rem;font-size: 14px;border-radius: 15px;"> <strong id="err">
                                        <strong>Whoops!</strong> @lang('quickadmin.qa_reset_password_woops')
                            <br><br>
                    ...
                    @endif
                        ...
                        <div class="row" style="padding:6rem 5rem;">
...
{{--                                            </div>--}}
                                            <div class="col-lg-12 col-xl-12 col-md-12 mt-2">
                                                <label class="text-muted h3">@lang('quickadmin.qa_confirm_password')</label>
                                <input type="password"
                                       class="form-control"
...
{{--                                            </div>--}}
                        ...
                        <div class="form-group">
                                                <div class="col-lg-12 col-xl-12 col-md-12 mt-5" style="text-align: center;">
                                <button type="submit"
