        ...
        <section class="form-main">
            <div class="container-fluid h-custom h-100">
                <div class="row h-100">
                    ...
                    @if (session('status'))
                                <div  class="alert alert-success alert-dismissible  show" role="alert" style="padding: 2rem 0rem;font-size: 14px;border-radius: 15px;"> <strong id="err">
                                        <strong>
                            {{ session('status') }}
...
{{--                        @endif--}}
                        ...
                        <div class="row" style="padding:11rem 5rem;">
                            ...
                            <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                                <p class="lead fw-normal mb-0 me-3" style="color:#6c757d!important;font-size: 30px;">Reset Password</p>
                    ...
                    <form class="form-horizontal"
                        ...
                        <div class="form-group">
                                                <div class="col-lg-12 col-xl-12 col-md-12 mt-3">
                                                    <label class="text-muted h3">Email</label>
                        ...
                        <div class="form-group">
                                                <div class="col-lg-12 col-xl-12 col-md-12 mt-3" style="text-align: center;">
                                <button type="submit"
