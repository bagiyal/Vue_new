...
<head>
    ...
    <title>Appointment Reminder Mail</title><!--[if (mso 16)]>
    <style type="text/css">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0;color: #757575;font-size:14px; font-weight: bold !important; ">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#757575 !important;font-size:14px">
                                                                    ...
                                                                    <br>
                                                                    Your Interview Appointment has been scheduled
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table></td>
                                                            ...
                                                            <td align="left" style="padding:0;Margin:0;color: #757575;font-size:14px; font-weight: bold !important; ">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="6" align="left" bgcolor="#1f557b" style="color:#ffffff;margin-top: 0px" class="">
                                                                    ...
                                                                    <tr >
                                                                        ...
                                                                        <td align="center">:</td>
                                                                        <td align="right">Shubham Handa</td>
                                                                    ...
                                                                    <tr >
                                                                        ...
                                                                        <td align="center">:</td>
                                                                        <td align="right">31-12-2022/10:00</td>

                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left">Type</td>
                                                                        <td align="center">:</td>
                                                                        <td align="right">Interview</td>

                                                                    </tr>
                                                                    <tr >
                                                                        <td align="left">Venue Address</td>
                                                                        <td align="center">:</td>
                                                                        <td align="right">Clock Tower, Dehradun</td>

                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left">Contact Person Name</td>
                                                                        <td align="center">:</td>
                                                                        <td align="right">Visharth</td>

                                                                    </tr>
                                                                    <tr >
                                                                        <td align="left">Contact Person Number</td>
                                                                        <td align="center">:</td>
                                                                        <td align="right">8218454872</td>
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                            <tr>
                                                <td valign="top" align="center" style="padding:0;Margin:0;width:490px">
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0;color: #757575;font-size:14px;  ">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#757575 !important;font-size:14px">
                                                                    <strong>Interview: </strong>
                                                                    Please find your Interview appointment details for VISA application above in your mail. Remember to carry your travel documents at the time of appointment.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table></td>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0;color: #757575;font-size:14px;  ">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#757575 !important;font-size:14px">
                                                                    <strong>Note: </strong>
                                                                    You are requested to reach 30 minutes prior, to avoid any inconvenience.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table></td>
