...
<head>
    ...
    <title>OTP Mail</title><!--[if (mso 16)]>
    <style type="text/css">
...
<?php
$agency_data=\App\User::select('name','address','banner_color')->where('id',get_agency_id_by_agent_id($agentId))->first();
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0;color: #757575; ">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#757575 !important;font-size:14px">
                                                                    <strong>
                                                                        Hi, <br/>
                                                                        Thank you for choosing {{$agency_data->name}}. Use the following OTP to complete your LogIn Process <br/><br/>
                                                                        <h2 style="background: {{ $agency_data->banner_color}};margin: 0 auto;width: max-content;padding: 10px;color: #fff;border-radius: 4px;">{{$otp}}</h2>
                                                                        <br/>
