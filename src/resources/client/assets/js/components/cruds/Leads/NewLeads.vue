<template>
    <section class="content-wrapper" style="margin-left: 5% !important;min-height: 960px;">
        <section>
            ...
            <!-- Modal -->
            <div class="container" style="position:absolute;z-index:999;"  v-if="this.xprops.ShowModel == true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
                            <button type="button" class="close" @click="Modelclose">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary"  @click="assign(selectedId)">Assign</button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-md-2">
                                    <div class="box-body">
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-default btn-sm" style="font-size: 15px;margin-left: 5px;background-color: #ffc107 !important;"  @click="fetchData">
...
<!--                            </div>-->
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <!-- <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-1 mt-3"> Query</div>
                                                        ...
                                                        <button class="btn btn-success btn-sm" @click="applyfilter()">Apply</button>
                            ...
                            <!-- <div class="input-group w-50">
                                ...
                                <i class="fa fa-eye"  style="z-index:2;padding: 3px"  aria-hidden="true" v-if="filter_obj.status" @click="filtermodel=true"></i>

                                <input type="text" v-model="localsearch" class="form-control" placeholder="Search">
                                <div class="input-group-append">
...
import NewLeadDatatableActions from '../../dtmodules/NewLeadDatatableActions'
...
export default {
    data() {
        return {
            columns: [
                ...
                { title: 'Travel Date', field: 'date', sortable: true ,tdComp:dateformat,tdClass: 'font_style',colStyle: 'width: 10%;',thClass: 'font_style2'},
                ...
                { title: 'Remark', field: 'created_by_team',  tdComp: lastremark, sortable: true ,tdClass: 'font_style',colStyle: 'width: 10%;' ,thClass: 'font_style2'},
                { title: 'Status', field: 'lead_status', sortable: true ,tdComp: statusdata,tdClass: 'font_style',thClass: 'font_style2'},
                // { title: 'Remark', field: 'remark', sortable: true },
                // { title: 'Adult guest', field: 'adult_guest', sortable: true },
                // { title: 'Score', field: 'score', sortable: true },
                // { title: 'Kids guests', field: 'kids_guests', sortable: true },
                ...
                // { title: 'Lead status', field: 'lead_status', sortable: true },
                { title: 'Cust. Status', field: 'lead_status', sortable: true ,tdComp: customerretention ,tdClass: 'font_style',thClass: 'font_style2'},
                { title: 'Actions', tdComp: NewLeadDatatableActions, visible: true, thClass: 'text-right', tdClass: 'text-right font_style', colStyle: 'width: 100px;',thClass: 'font_style2' }
            ],
            selectedName:'',
            selectedId:'',
            options:[],
    ...
    created() {
        ...
        this.$root.relationships = this.relationships
         ...
         if(this.user_role=='agency'){
            ...
            params.set('flag', 2)
            axios.post('/api/v1/users_of_agency', params).then(res=>{
    ...
    computed: {
        ...mapGetters('LeadsIndex2', ['search','data','column', 'total', 'loading', 'relationships','filter_obj']),
    },
    watch: {
    ...
    methods: {
        ...mapActions('LeadsIndex2', ['fetchData', 'setQuery', 'resetState' ,'setsearch' , 'setcolumn','setfilter']),
        updatesearch() {
        ...
        assign(id){
         ...
         console.log("done");
         axios.get('/api/v1/leads/assign/' + this.xprops.lead_id +'/' + id)
        .then(response => {
