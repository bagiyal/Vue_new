...
export default {
    ...
    methods: {
        ...mapActions('AccommodationsSingle', ['storeData', 'resetState', 'setTitle', 'setDescription', 'setContact_no', 'setAccommodation_address', 'setFeatured_image', 'setWebsite_address', 'setCheck_in_time', 'setCheck_out_time', 'setLatitude', 'setLongitude', 'setCity', 'fetchCitiesAll']),
        updateTitle(e) {
