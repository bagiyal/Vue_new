...
export default {
    data() {
        return {
            columns: [
                ...
                // { title: 'Accommodation address', field: 'accommodation_address', sortable: true },
                // { title: 'Featured image', tdComp: DatatableFeaturedImageField, sortable: false },
                { title: 'Website address', field: 'website_address', sortable: true },
                // { title: 'Check in time', field: 'check_in_time', sortable: true },
                // { title: 'Check out time', field: 'check_out_time', sortable: true },
    ...
    computed: {
        ...mapGetters('AccommodationsIndex', ['data', 'total', 'loading', 'relationships']),
    },
    watch: {
        query: {
            handler(query) {
    ...
    methods: {
        ...mapActions('AccommodationsIndex', ['fetchData', 'setQuery', 'resetState','setsearch']),
        updatesearch() {
