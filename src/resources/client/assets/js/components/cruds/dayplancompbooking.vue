        ...
        <div v-show="mode">
            ...
            <div v-for="(location,index ) in tour_location"  v-show="showlocation === location.name+index ">
                ...
                <div  class="col-xs-12" v-for="(day,index2 ) in parseInt(location.daynights)" :key="day" v-show="showday === day+index2">
                    ...
                    <button v-else @click="changeview" class="button-css">Exe. & Transport </button>
...
<!--                                            <p>* Note:- Please Fill All Required Fields.</p>-->
...
<script>
    ...
    export default{
        ...
        computed:{
            ...mapGetters('BookingsSingle', ['placedata','addplacemodal','add_place_modal_status'])
        },
...
// this.addplacemodal=false;
        ...
        methods: {
            ...mapActions('BookingsSingle', ['addPlace','closeplace','fetchplace','setday_plan_mounted_status']),
            editall(){
                //     alert("g")
                this.mode=false
