...
export default {
    ...
    methods: {
        ...mapActions('DriversSingle', ['storeData', 'resetState', 'setName', 'setPhone', 'setemail', 'setRating', 'setDate_of_birth', 'setDrivers_license_number', 'setDrivers_license_state', 'setDrivers_license_expiration_date', 'setRelationdeviceid']),
        updateName(e) {
