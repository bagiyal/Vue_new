...
<div class="container">
    <section class="content-header" style="margin:-70px -83px 0px 0px">
        ...
        <div class="row ml-5">
            ...
            <div class="col-lg-6 offset-lg-3 f-1-8">
        ...
        <div class="row ml-5" v-if="sale_detail_div">
    <div class="col-12">
        <div class="row">
            <div class="col-lg-6"><i class="fa fa-times" aria-hidden="true"  @click="sale_detail_div=false"></i>

                <!-- <h1 class="mt-5 text-dark">Scheduled Departures</h1> -->
                <div class="jumbotron bg-w" style="position: absolute;z-index: 500;">
                <!-- {{this.sale_detail}} -->
        ...
        <div class="row ml-5">
            ...
            <div class="col-2 ml-4 mr-1 text-center bg-light"  @click="sale_detail_div=true">
            ...
            <div class="col-2 ml-5 mr-3 text-center bg-light">
            ...
            <div class="col-2 ml-5 text-center bg-light">
              ...
              <div class="row">
                  <div class="col-lg-12">
                      ...
                      <tbody id="tbody_task">
                        ...
                        <td>{{ task.name }}</td>
                        <td>{{ task.remark }}</td>
                        <td><i class="fa fa-thumbs-up" style="font-size:24px;color:#1e51a4;cursor: pointer;" @click=update_tasks(task.id) v-if="task.id"></i></td>
        ...
        <div class="row ml-5">
            ...
            <div class="col-12"><div style="position: absolute;color: white;width: 20%;margin-left: 5%;height: 100%;text-align: center;font-size: 20px;font-weight: bold;padding-top: 10px;">Live Itinerary<br>{{live_iti}}</div>
            <div style="position: absolute;color: white;width: 20%;margin-left: 36%;height: 100%;text-align: center;font-size: 20px;font-weight: bold;padding-top: 10px;">Live Group Events<br>{{live_group}}</div>
            <div style="position: absolute;color: white;width: 20%;margin-left: 70%;height: 100%;text-align: center;font-size: 20px;font-weight: bold;padding-top: 10px;">Live Queries<br>{{live_query}}</div>
    ...
    export default {
        ...
        created(){
            ...
            this.city_chartData.push(['City','-'])
              ...
              for(var r=0;r<today_arr_result.length;r++){
                var city_data=JSON.stringify(today_arr_result[r]);
          ...
          for(var i=0;i<this.selling_price.length;i++){
            ...
            today_price=parseInt(today_price)+parseInt(this.selling_price[i]['tour_markup']);
              var myArray = {price_tour: this.selling_price[i]['price_tour'] ,
...
// //console.log(this.agency_data['today']);
    ...
    // alert(city_counter);
    // if(city_counter==0){
    // this.city_chartData.push(['Today','City'],['0','0'],['0','0'])
    // }else{
