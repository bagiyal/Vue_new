                    ...
                    <form @submit.prevent="submitForm" novalidate>
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="ref_role">Ref role</label>
                                    <input
                                            type="text"
                                            class="form-control"
                                            name="ref_role"
                                            placeholder="Enter Ref role"
                                            :value="item.ref_role"
                                            @input="updateRef_role"
                                            >
                                </div>
                            </div>
...
export default {
    ...
    computed: {
        ...mapGetters('FieldOperatorsSingle', ['item', 'loading']),
    },
    created() {
    ...
    methods: {
        ...mapActions('FieldOperatorsSingle', ['fetchData', 'updateData', 'resetState', 'setName', 'setPhone', 'setRating', 'setDate_of_birth', 'setDrivers_license_number', 'setDrivers_license_state', 'setDrivers_license_expiration_date', 'setRelationdeviceid', 'setRef_role']),
        updateName(e) {
        ...
        updateRef_role(e) {
            this.setRef_role(e.target.value)
        },
        submitForm() {
            this.updateData()
                .then(() => {
                    this.$router.push({ name: 'field_operators.index' })
