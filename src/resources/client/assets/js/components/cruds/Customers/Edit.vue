...
export default {
    ...
    methods: {
        ...mapActions('CustomersSingle', ['fetchData', 'updateData', 'resetState', 'setName', 'setEmail', 'setAccount_manager', 'setAgree', 'setAddress', 'setCity', 'setState', 'setCountry', 'setPhone', 'setPostcode', 'setDevice', 'setLocale', 'setLogin', 'setLogin_date_time', 'setLogin_status', 'setMycred_default', 'setMycred_default_total', 'setMycred_epp_mycred', 'setProfile', 'setFacebook', 'setGoogle', 'setOtp', 'setRegistered_thru']),
        updateName(e) {
