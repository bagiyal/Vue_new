    ...
    data() {
        return {
            columns: [
                ...
                { title: 'Profile', field: 'profile', sortable: true },
                { title: 'Facebook', field: 'facebook', sortable: true },
                { title: 'Google', field: 'google', sortable: true },
                { title: 'Otp', field: 'otp', sortable: true },
                { title: 'Registered thru', field: 'registered_thru', sortable: true },
