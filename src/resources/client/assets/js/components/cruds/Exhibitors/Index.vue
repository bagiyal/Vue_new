...
export default {
    data() {
        return {
            columns: [
                ...
                { title: 'History', field: 'history', sortable: true },
                { title: 'Device id', field: 'device_id', sortable: true },
            ...
            xprops: {
                module: 'ExhibitorsIndex',
                route: 'exhibitors',
                permission_prefix: 'exhibitor_'
            }
        }
    },
    created() {
    ...
    computed: {
        ...mapGetters('ExhibitorsIndex', ['data', 'total', 'loading', 'relationships']),
    },
    watch: {
        query: {
            handler(query) {
    ...
    methods: {
        ...mapActions('ExhibitorsIndex', ['fetchData', 'setQuery', 'resetState']),
    }
}
</script>
