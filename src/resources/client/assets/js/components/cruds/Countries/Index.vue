...
export default {
    data() {
        return {
            columns: [
                ...
                { title: 'Shortcode', field: 'shortcode', sortable: true },
    ...
    computed: {
        ...mapGetters('CountriesIndex', ['data', 'total', 'loading', 'relationships']),
    },
    watch: {
        query: {
            handler(query) {
    ...
    methods: {
        ...mapActions('CountriesIndex', ['fetchData', 'setQuery', 'resetState','setsearch']),
        updatesearch() {
