        ...
        <div v-show="mode">
            ...
            <div v-for="(location,index ) in tour_location"  v-show="showlocation === location.name+index ">
                ...
                <div  class="col-xs-12" v-for="(day,index2 ) in parseInt(location.daynights)" :key="day" v-show="showday === day+index2">
                    ...
                    <button v-else-if="tour_location.length==index+1 && button_text"  @click="changeview" class="button-css">{{button_text}}</button>
<!--                    button_text-->
                                                            ...
                                                            <draggable v-model="objj[location.id]['day-'+day]['place']" group="people" @start="drag=true" @end="drag=false,allplace=false,allplace=true">
                                                                ...
                                                                <div v-for="(placeinfo, index) in objj[location.id]['day-'+day]['place']">
                                                                    <div  class="col-12" style="overflow: hidden"  v-show="allplace">
                                                                        ...
                                                                        <i v-if="!placeinfo['attendance']['status']" style="" @click="placeinfo['attendance']['status']=true,allplace=false,allplace=true"  class="fa fa-thumb-tack" aria-hidden="true"></i>
                                                                        <i v-else style="color:#0ee80e"   class="fa fa-thumb-tack" aria-hidden="true" title="Attendance"></i>

                                                                        <div class="row" v-if="placeinfo['attendance']['status']">
                                                                            <div class="col-md-1" style="margin-top: 3px;">
                                                                                <label class="container_input">
                                                                                    <input type="checkbox" v-model="placeinfo['attendance']['status']"  >
                                                                                    <span class="checkmark" style="border:1px solid; width: 23px !important;height:23px !important;"></span>
                                                                                </label></div>
                                                                            <div class="col-md-5" style="font-size: 21px;margin-top: -2px;color: black;">Attendance</div>

                                                                            <i style="padding: 5px;font-size: 23px" @click="fetch_attendance(placeinfo['title'],location.id,'day-'+day,placeinfo['id'])"  class="fa fa-eye" aria-hidden="true"></i> See Report
                                                                        </div>
                                                            ...
                                                            <div v-for="(placeinfo, index1) in objj[location.loc][location.day]['place']">
                                                                <div  class="col-12" style="overflow: hidden"  v-show="allplace">
                                                                    ...
                                                                    <div class="row" v-if="placeinfo['attendance']['status']">
                                                                        ...
                                                                        <i style="padding: 5px;font-size: 23px" @click="fetch_attendance(placeinfo['title'],location.loc,location.day,placeinfo['id'])"   class="fa fa-eye" aria-hidden="true"></i> See Report
                                                                    </div>
                                    ...
                                    <div class="modal-body" style="">
                                        <div class="container-fluid c-grey">
                                            ...
                                            <div class="row no-gutters mt-4">
                                                ...
                                                <div class="col-12 col-sm-6 col-md-9">
                                                    <!--                                                    <label class="f-1-6">-->
                                                    <!--                                                        <img src="./dashboard_resources/upload-1.png" class="w-25 cursor">-->
                                                    <!--                                                        <input type="file"-->
...
<!--                                            </div>-->
        ...
        <div v-if="attendance_model===true">
            <transition name="modal">
                <div class="modal-mask">
                    <div class="modal-wrapper">
                        <div class="modal-dialog add_width">
                            <div class="modal-content">
                                <div class="modal-header border-0 border-dotted">
                                    <div class="container-fluid pr-0 border-bottom"
                                        style="border-bottom-style:dotted !important">
                                        <div class="row" style="padding:1rem;">
                                            <div class="col-3" style="padding-top:1rem">
                                                <h1 style="color: black;">{{ this.total_traveller }}</h1>
                                                <h3>Overall Traveller</h3>
                                            </div>
                                            <div class="col-3" style="border: 1px solid green; border-radius: 10px;margin-right:1rem;padding-top:1rem">
                                                <h1 style="color: green; font-weight: 600;">{{this.present_traveller}}</h1>
                                                <h4 style="color: green;">Present</h4>
                                            </div>
                                            <div class="col-3" style="background-color: rgb(249, 204, 204); opacity: 0.8;border-radius: 10px;padding-top:1rem">
                                                <h1 style="font-weight: 600; color: red;">{{this.absent_traveller}}</h1>
                                                <h4 style="color: red;">Absent</h4>
                                            </div>
                                            <!-- <div class="col-5">
                                                <h1>{{this.final_result}}</h1>
                                                <h1>1918</h1>
                                            </div> -->
                                            <div class="col-2" @click="download_report()" style="cursor: pointer; margin-left: 0%;text-align: center;padding-top:1rem">
                                                <img src="../dashboard_resources/excel.png" style="width: 32px;" alt="Excel"><br>
                                            <h4>Excel</h4>
                                                <!-- <i class="fa  fa-download" style="color: rgb(44, 151, 44); font-size: larger;" aria-hidden="true"></i> -->
                                            </div>
                                            
                                            
                                                <button style="position: absolute;right: 19px;top: 16px;" type="button" class="close" @click="attendance_clean">
                                ...
                                <div class="modal-body" style=" height: 70vh;    overflow-y: auto;">
                                    <div class="container-fluid c-grey">
                                        <div class="row" style="background-color: whitesmoke;">
                                            <div class="col-md-2 model-head-text">
                                               MEM ID
                                            </div>
                                            <div class="col-md-2 model-head-text">
                                                Traveler Name
                                            ...
                                            <div class="col-md-4 model-head-text">
                                                Time
                                            </div>

                                        </div>

                                <div  class="row" v-for="att in attendance_data ">
                                            <div class="col-md-2 model-content-text">
                                            {{ att.booking_id }}
                                        </div>
                                            <div class="col-md-2 model-content-text">
                                            {{ att.traveler_name }}
                                            ...
                                            <div class="col-md-2 model-content-text">
                                                <span v-if="att.attendance_status == 0">
                                                    <p style="color: red;">Absent</p>
                                                    <!-- <i style="color:#e59745" class="fa fa-clock-o" aria-hidden="true"></i> -->
            </span>
                                            <span v-if="att.attendance_status==1" >
                                                    <p style="color: rgb(133, 207, 21);">Present</p>
                                            ...
                                            <div class="col-md-4 model-content-text">
                                            {{ att.time }}
                                        </div>
...
<script>
    ...
    export default{
        ...
        computed:{
            ...mapGetters('GroupsSingle', ['placedata','addplacemodal','add_place_modal_status'])
        },

        mounted(){
            this.showlocation=this.tour_location[0].name+0
            this.showlocation2=this.tour_location[0].name;
            this.showday=1+0
...
// this.addplacemodal=false;
        ...
        methods: {
            ...mapActions('GroupsSingle', ['addPlace','closeplace','fetchplace','setday_plan_mounted_status']),

            fetch_attendance(title,location,day,place_id){

            // set data 
            this.downloadlocationid = location;
            this.downloadplaceid = place_id;
            this.downloaddayid = day;
                this.attendance_model=true;
                this.attendance_title=title;

                let form = new FormData();
                form.set('location', location);
                form.set('day',day);
                form.set('place_id', place_id);
                form.set('group_id', this.group_id);
                axios.post('/api/webservices/fetch_attendance', form)
                    .then(response => {
                    this.attendance_data = response.data.members;
                    this.final_result = response.data.attendance;
                    this.total_traveller = response.data.total;
                    // console.log(this.total_traveller);
                    this.absent_traveller = response.data.absent;
                    this.present_traveller = response.data.present;
                        // response.data.forEach((dataObj) => {
                        //
                        //     this.doc_req_list.push(dataObj.value)
                        // });
                    });
           //    console.log(location,day,place_id)
            },
            attendance_clean(){
                this.attendance_model=false;
                this.attendance_title='';
                this.attendance_data=[];
            },
        download_report(){
            // console.log(" report ",this.tour_location[0].id,this.place,this.group_id)
            // console.log(" report ",this.downloadlocationid,this.downloadplaceid,this.downloaddayid)

            let form=new FormData();
            form.set('id',this.group_id);
            form.set('placeid',this.downloadplaceid);
            form.set('locationid',this.downloadlocationid);
            form.set('type','attendance_status');
            form.set('day',this.downloaddayid.split("-")[1]);
            ...
            if(response.data.status){
                ...
                const file_name = "attendance_report";
        ...
        exportToCsv(filename, rows) {
            ...
            clplace(e){
                // if(e=='refresh'){
                //     this.fetchplace(Object.keys(this.place)[0]);
                // }
                if(e){
                    this.setday_plan_mounted_status(true);
                }
...
//     if(index==0){
        ...
        props: ['place','tour_location','datestart','meal','summ','hotel','itiplaces','license','group_id','button_text']
    }
</script>
<style scoped>
    input[type="file"] {
