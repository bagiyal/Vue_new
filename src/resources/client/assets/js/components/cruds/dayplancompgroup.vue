        ...
        <div v-show="mode">
            ...
            <div v-for="(location,index ) in tour_location"  v-show="showlocation === location.name+index ">
                ...
                <div  class="col-xs-12" v-for="(day,index2 ) in parseInt(location.daynights)" :key="day" v-show="showday === day+index2">
                    ...
                    <button v-else @click="changeview" class="button-css">Personalise App </button>
                                                            ...
                                                            <div v-for="(placeinfo, index) in objj[location.id]['day-'+day]['place']">
                                                                <div  class="col-12" style="overflow: hidden"  v-show="allplace">
                                                                    ...
                                                                    <div class="row" v-if="placeinfo['attendance']['status']">
                                                                        ...
                                                                        <i style="padding: 5px;font-size: 23px"   class="fa fa-eye" aria-hidden="true"></i> See Report
                                                                    </div>
...
<!--                                                            <input type="radio"  :name="'radioplace'+location.loc"  @change="changedisplay('allplace')" class="overflow-control-input" checked>-->
...
<!--                                                            <input type="radio" :name="'radioplace'+location.loc" @change="changedisplay('privateplace')" class="overflow-control-input" >-->
...
<!--                                                            <input type="radio" :name="'radioplace'+location.loc" @change="changedisplay('transferplace')" class="overflow-control-input" >-->
        ...
        watch: {
            ...
            tour_location: {
                handler(query) {
                    ...
                    console.log('alldaycounter')
                    console.log(this.alldaycounter)
                },
                deep: true
            },
...
//     if(index==0){
            ...
            preselect(a,b,locationid,place){
                if(typeof a !== 'undefined' && typeof b !== 'undefined' && typeof locationid !== 'undefined' && typeof place !== 'undefined'  ){
                    ...
                    if(_.isEmpty(this.objj)){
                        ...
                        this.temp[locationid]['day-'+day]={'place':this.days[day],'meal': this.mealday[day]};
                        this.objj = Object.assign(this.objj, this.temp);
                        this.temp = Object.assign({}, {});
            ...
            addtoplaces(day,locationid,editplan){
                ...
                if( this.objj.hasOwnProperty(locationid)){
                    ...
                    if(this.objj[locationid].hasOwnProperty('day-'+day)){
                        ...
                        this.objj[locationid]['day-'+day].meal=_.clone(this.mealday[day])
                    }
                    else{


                        // Object.assign( this.objj[locationid], {['day-'+day]: {'place':_.clone(this.days[day])}})
                        Object.assign( this.objj[locationid], {['day-'+day]: {'meal':_.clone(this.mealday[day])}})
                    ...
                    this.temp[locationid]['day-'+day]={'meal':_.clone(this.mealday[day])};
        ...
        props: ['place','tour_location','datestart','meal','summ','hotel','license']
