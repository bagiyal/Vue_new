                                    ...
                                    <div class="box-body" >
                                        <div class="btn-group" >
                                            <router-link
                                                ...
                                                v-if="$can(xprops.permission_prefix + 'create') && user_role=='agency'"
...
import DatatableActions_forms from '../../dtmodules/DatatableActions_forms'
...
export default {
    data() {
        return {
            columns: [
                ...
                { title: 'Form name', field: 'form_name', sortable: true ,tdClass: 'font_style',thClass: 'font_style2'},
                { title: 'Actions', tdComp: DatatableActions_forms, visible: true, thClass: 'text-right font_style2', tdClass: 'text-right font_style', colStyle: 'width: 130px;' }
            ],
            query: { sort: 'id', order: 'desc' },
            xprops: {
                module: 'FormsIndex',
                route: 'forms',
                permission_prefix: 'form_'
            },
            user_role:'',
            clear:false,
            search:true,
    ...
    methods: {
        ...mapActions('FormsIndex', ['fetchData', 'setQuery', 'resetState','setsearch' , 'setcolumn']),
        updatesearch() {
