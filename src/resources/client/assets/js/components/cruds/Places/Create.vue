...
export default {
    ...
    computed: {
        ...mapGetters('PlacesSingle', ['item', 'loading', 'citiesAll', 'teamsAll','cat'])
    },
    created() {
        this.fetchCitiesAll(),
        this.fetchTeamsAll(),
    ...
    methods: {
        ...mapActions('PlacesSingle', ['storeData', 'resetState', 'setTitle', 'setDescription', 'setContact_no', 'setTiming', 'setClosed_day', 'setTime_required_to_visit', 'setCategories', 'setEsb_visiblity', 'setAddress', 'setPlace_longitude', 'setPlace_latitude', 'setCity', 'setFeatured_image', 'setGallery', 'destroyGallery', 'destroyUploadedGallery', 'setCuisine', 'setRecommended', 'setPartner', 'setPlace_tripadvisor_id', 'setCity_id', 'setCreated_by_team', 'fetchCitiesAll', 'fetchTeamsAll','fetchcat']),
        ...
        updateCity(value) {
            ...
            this.item.city_id=_.cloneDeep(cities)
