...
import DatatableActions from '../../dtmodules/DatatableActionsBooking'
...
export default {
    data() {
        return {
            columns: [
                ...
                { title: 'Itinerary', field: 'tour_name', sortable: true ,colStyle: 'width: 15%;',tdClass: 'font_style',thClass: 'font_style2'},
                { title: 'Itinerary No.', field: 'booking_id', sortable: true ,tdClass: 'font_style',thClass: 'font_style2'},
                { title: 'Travel Date', field: 'driver_pick_up_time', tdComp: dateonlybooking ,tdClass: 'font_style',thClass: 'font_style2'},

                { title: 'Traveller Name', field: 'full_name', sortable: true,tdClass: 'font_style',thClass: 'font_style2' },
                { title: 'Mobile No.', field: 'phone', sortable: true ,tdClass: 'font_style',thClass: 'font_style2'},
                { title: 'Login', field: 'login', tdComp: login,tdClass: 'font_style',thClass: 'font_style2'},
                { title: 'Ops. Assign', field: 'score', tdComp: ops ,tdClass: 'font_style',thClass: 'font_style2'},
                // { title: 'Activated', field: 'activated', sortable: true },
                { title: 'Activated', field: 'score', tdComp: activated ,tdClass: 'font_style',thClass: 'font_style2'},
                { title: 'Status', field: 'score', tdComp: statusbooking,tdClass: 'font_style',thClass: 'font_style2', colStyle: 'width: 60px;'},
                { title: 'Actions', tdComp: DatatableActions, visible: true, thClass: 'text-right font_style2', tdClass: 'text-right font_style', colStyle: 'width: 60px;' }
            ],
    ...
    computed: {
        ...mapGetters('BookingsIndex', ['search','data','column', 'total', 'loading', 'relationships','filter_obj']),
    },
    watch: {
    ...
    methods: {
        ...mapActions('BookingsIndex', ['fetchData', 'setQuery', 'resetState','setsearch' , 'setcolumn','setfilter']),
        updatesearch() {
