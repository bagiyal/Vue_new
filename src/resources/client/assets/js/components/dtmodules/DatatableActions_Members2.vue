...
<!--                                                                                            />-->
        ...
        <button type="button" class="btn " @click="getdata"><i class="fa fa-briefcase button_style"  alt="Update Documents" Title="Update Documents" aria-hidden="true" :style="{ color: docs.color}"></i></button>
  ...
  export default {
    ...
    beforeCreate() {
      this.currentHook = "beforeCreate";
    },
    created() {
            console.log('kyc',JSON.stringify(this.row));
    },
    beforeMount() {
      this.currentHook = "beforeMount";
    },
    mounted() {
      this.currentHook = "mounted";
    },
    beforeUpdate() {
      this.currentHook = "beforeUpdate";
    },
    updated() {
      this.currentHook = "updated";
    },
    beforeDestroy() {
      this.currentHook = "beforeDestroy";
    },
    destroyed() {
      this.currentHook = "destroyed";
    },
    methods:{
        ...
        getdata() {
            try {
                this.loading2 = false;
        axios
            .get('/api/v1/groupsmemberdoc/' + this.row.id)
            .then((response) => {
                this.doc_data_new=response.data.data
                    ...
                    // console.log("--------",this.doc_data_new[0].member_doc_tags,this.doc_data_new[0].meta_family,this.doc_data_new[0].meta_pass);
